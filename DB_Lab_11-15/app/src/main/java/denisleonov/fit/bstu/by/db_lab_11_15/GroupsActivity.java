...
public class GroupsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinnerGa = findViewById(R.id.spinnerGA);
        ...
        db = new DBHelper(GroupsActivity.this);
        loadData(1);
    }

    private void loadData(int i){
        List<String> progress = db.GetGroup(i);
        ListView progressLV = findViewById(R.id.groupsListGA);
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, progress);
        progressLV.setAdapter(adapter);
    }

    public void testIdTriggerBtn(View view) {
        db.TestThirdTrigger();
    }
}