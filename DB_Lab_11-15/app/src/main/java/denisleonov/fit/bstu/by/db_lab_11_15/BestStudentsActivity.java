...
public class BestStudentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinnerGa = findViewById(R.id.spinnerBSA);
        ...
        db = new DBHelper(BestStudentsActivity.this);
        loadData(1);
    }

    private void loadData(int i){
        List<String> bestStudents = db.GetBest(i);
        ListView progressLV = findViewById(R.id.groupsListBSA);
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, bestStudents);
